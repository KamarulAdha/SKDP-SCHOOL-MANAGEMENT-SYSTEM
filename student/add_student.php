...
<div class="content">
  ...
  <div class="main_content">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <span class="col-sm-4 control-label"> </span> </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="txtStRollNo"> Student ID * </label>
                        <div class="col-sm-6">
    ...
    source: "<?php echo WEB_URL; ?>ajax/getparentsinfo.php" // name of controller followed by function
            ...
            var inner_html = '<a href="javascript:;" onclick="setParentsValue('+item.id+');"><div class="list_item_container"><div class="image"><img class="photo_img_round" style="width:60px;height:60px;" src="<?php echo WEB_URL; ?>img/upload/' + item.image + '"></div><div class="label">Name: ' + item.label + '</div></div></a>';
            return $( "<li></li>" )
