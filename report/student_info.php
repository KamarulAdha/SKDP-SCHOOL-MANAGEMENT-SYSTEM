...
?>
  ...
  <br/>
  <div>
    <div align="center" style="font-size:20px; font-weight:bold; color:black; text-align:center; margin-top:20px; margin-bottom:20px; text-decoration:underline;">FIRST TERM EXAM</div>
    <div align="left" style="width:100%; margin-bottom:30px;">
      <table class="gridtable" align="left"  style="width:100%">
        <thead>
          <tr>
  ...
  <br/>
  <div>
    <div align="center" style="font-size:20px; font-weight:bold; color:black; text-align:center; margin-top:20px; margin-bottom:20px; text-decoration:underline;">SECOND TERM EXAM</div>
    <div align="left" style="width:100%; margin-bottom:30px;">
      <table class="gridtable" align="left"  style="width:100%">
        <thead>
          <tr>
  ...
  <br/>
  <div>
    <div align="center" style="font-size:20px; font-weight:bold; color:black; text-align:center; margin-top:20px; margin-bottom:20px; text-decoration:underline;">FINAL TERM EXAM</div>
    <div align="left" style="width:100%; margin-bottom:30px;">
      <table class="gridtable" align="left" style="width:100%">
        <thead>
          <tr>
